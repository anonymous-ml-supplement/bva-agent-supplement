...
IN = "../artifacts/reported_results/joint_calibration/joint_calibration_exactTopB100_eval_raw.csv"
OUT = "../artifacts/reported_results/joint_calibration/joint_calibration_exactTopB100_eval_bootstrap_ci.txt"
...
PAIRS = [
    ...
    ("H_only_eval", "p_only_eval"),
    ("p_times_H_eval", "H_only_eval"),
    ("p_times_H_calibrated_eval", "p_times_H_eval"),
    ("p_times_H_calibrated_eval", "H_only_eval"),
    ("p_times_H_calibrated_eval", "p_only_eval"),
]
METRICS = [
    "success",
...
lines = []
lines.append("Joint calibration exactTopB100 eval bootstrap CI")
